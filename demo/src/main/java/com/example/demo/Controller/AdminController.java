...
public class AdminController {
    ...
    public String deletestudent(StudentModel student,@RequestParam("student_id") long student_id) {
    	if(!adminService.areIdsPresent(student_id)) {
	        return "admin/studentidNotPresent";
	    }
    ...
    public String deleteCourse(CourseModel course,@RequestParam("id") long id) {
    	if(!adminService.coursidispresent(id)) {
	        return "admin/courseidNotpresent";
	    }
    ...
    public String updateStudent(StudentModel student,@RequestParam("student_id") long student_id) {
        try {
        	if(!adminService.areIdsPresent(student_id)) {
    	        return "admin/student_idError";
    	    }
    ...
    public String updateCourse(CourseModel course,@RequestParam("id") long id) {
        try {
        	if(!adminService.coursidispresent(id)) {
    	        return "admin/Course_idError";
    	    }
